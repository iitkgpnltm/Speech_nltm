...
function [vgclocssp1,vf0sp1,epstrsp1]=zff_based_pitch_contour(sp1sig,fs);


%sp1sig=wavread('prosody_comparison/1.wav');
...
epssp1=epssp1./(max(epssp1));%smoothening
...
vgclocssp1=gclocssp1(epssp1); % epoch location in samples 
vf0sp1=f0sp1(epssp1); % pitch values at samples 
