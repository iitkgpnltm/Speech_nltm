clear all; 
close all;
input_wav='E:\NLTM Project\Tesing_code\APTS_ZFF\input_wave\power_elec_sen1.wav';
...
writetable(Table_out, 'E:\NLTM Project\Tesing_code\APTS_ZFF\output_file\Pitch_label.txt','Delimiter','\t'); 
